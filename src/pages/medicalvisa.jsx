...
const Medicalvisa = () => {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      const navbar = document.querySelector(".medicalvisa-navbar");
      if (navbar) {
    ...
    const initializeMasonry = () => {
      const grid = document.querySelector(".medicalvisa-comparison-grid");
      if (grid) {
        new Masonry(grid, {
          itemSelector: ".medicalvisa-country-card",
          columnWidth: ".medicalvisa-grid-sizer",
          gutter: ".medicalvisa-gutter-sizer",
  ...
  return (
    <>
      <div className="medicalvisa-top-bar">
        <div className="medicalvisa-container">
      ...
      <a
        ...
        className="medicalvisa-whatsapp-float"
        target="_blank"
      >
        <i className="bi bi-whatsapp" />
      </a>
      {/* Hero Section */}
      <section className="medicalvisa-hero">
        <div className="medicalvisa-hero-content">
          <div className="medicalvisa-hero-box">
      ...
      {/* Country Cards Grid */}
      <div className="medicalvisa-comparison-grid" id="compare">
        <div className="medicalvisa-grid-sizer" />
        <div className="medicalvisa-gutter-sizer" />
        {/* Fixed USA Card */}
        <div className="medicalvisa-country-card">
          <div className="medicalvisa-country-header">
            <span className="medicalvisa-country-flag">🇺🇸</span>
            <div className="medicalvisa-country-title">
              <h2>United States</h2>
              <p>B-2 Medical Visa</p>
            </div>
          </div>
          <div className="medicalvisa-country-content">
            <div className="medicalvisa-info-section">
              <h3>Visa Requirements</h3>
              <ul className="medicalvisa-requirements-list">
            ...
            <div className="medicalvisa-info-section">
              ...
              <ul className="medicalvisa-work-rights-list">
            ...
            <div className="medicalvisa-stats-box">
            ...
            <div className="medicalvisa-action-buttons">
        ...
        <div className="medicalvisa-country-card">
          ...
          <div className="medicalvisa-country-content">
            <div className="medicalvisa-info-section">
              <h3>Visa Requirements</h3>
              <ul className="medicalvisa-equirements-list">
